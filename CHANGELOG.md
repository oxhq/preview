...
- Added CI, release workflow, clean consumer smoke, Packagist install smoke, tunnel startup smoke, Stripe CLI smoke path, GitHub/Packagist release checkers, release hygiene docs, and a release-surface checker so the package can distinguish local package readiness from published release proof.
