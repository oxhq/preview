...
- Added provider sample generation, provider self-tests, capture integrity hashes, capture comparison, capture timeline summaries, fixture inventory stats, route metadata export, scenario metadata export, and source archive hygiene checks.
