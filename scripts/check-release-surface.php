...
$check(is_file($path('scripts/sync-packagist.php')), 'scripts/sync-packagist.php exists');
...
$check(is_file($path('scripts/smoke-shopify-webhook.ps1')), 'scripts/smoke-shopify-webhook.ps1 exists');
